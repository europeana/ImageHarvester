...
public class MachineResourceReference {
    ...
    public MachineResourceReference(final String id, final Date lastPingCheck,
                                    final List<ReferenceOwner> referenceOwnerList,
                                    final Long bandwidthLimitReadInBytesPerSec,
                                    final Long maxConcurrentConnectionsLimit) {
        this.id = id;
