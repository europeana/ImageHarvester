...
public class MigrationManagerTest {
    ...
    public void testDBIteration_AllDatabase() throws IOException {
        ...
        final DBCollection sourceDocumentReferences = mongoDBUtils.connectToTarget().getCollection("SourceDocumentReference");
    ...
    public void testDBIteration_FilterByDate_BatchSize2_AllMinus2() throws IOException {
        ...
        mongoDBUtils.loadMongoData(MigratorUtils.PATH_PREFIX + "data-files/filterSomeByDate/aggregation.json", "Aggregation");
