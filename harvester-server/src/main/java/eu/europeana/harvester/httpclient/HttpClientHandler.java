...
class HttpClientHandler extends SimpleChannelHandler {
    ...
    private static final Logger LOG = LogManager.getLogger(HttpClientHandler.class.getName());
    ...
    /**
     * Timestamp of the moment when the connection is started.
     */
    private final long connectionStartTime;

    /**
     * Timestamp of the moment when the download is started.
     */
     ...
     * @param ctx
     */
    private void handleHeaders(final HttpResponse response, final ChannelHandlerContext ctx) {
        // Reads the headers
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) {
        ...
        if(e.getCause() instanceof ClassCastException) {
            httpRetrieveResponse.setLog("In HttpClientHandler: an error occurred at socket level, " +
                    "we does not received default HTTP response");
        } else {
            httpRetrieveResponse.setLog("In HttpClientHandler: \n" + e.getCause().toString());
        }
