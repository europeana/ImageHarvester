...
public class SourceDocumentReferenceDaoImplTest {
    ...
    public void testCreate() throws Exception {
        ...
        sourceDocumentReferenceDao.delete(sourceDocumentReference, WriteConcern.NONE);
    }
    ...
    public void testUpdate() throws Exception {
        ...
        sourceDocumentReferenceDao.delete(newSourceDocumentReference, WriteConcern.NONE);
    }
    ...
    public void testDelete() throws Exception {
        final SourceDocumentReference sourceDocumentReference =
                new SourceDocumentReference(new ReferenceOwner("1", "1", "1"), "test", null, null, 0l, null);
        assertFalse(sourceDocumentReferenceDao.delete(sourceDocumentReference, WriteConcern.NONE));
        sourceDocumentReferenceDao.createOrModify(sourceDocumentReference, WriteConcern.NONE);
        ...
        assertTrue(sourceDocumentReferenceDao.delete(sourceDocumentReference, WriteConcern.NONE));
