...
scp ./harvester.jar crfharvester@dev1.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
# start the master
...
scp ./harvester.jar crfharvester@dev2.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@dev2.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@dev3.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@dev3.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@dev4.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@dev4.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod1.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
...
#scp ./harvester.jar crfharvester@prod2.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
#ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@prod2.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod3.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@prod3.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod4.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@prod4.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod5.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@prod5.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod6.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
ssh -i ./id_rsa -o StrictHostKeyChecking=no crfharvester@prod6.crf.europeana.eu 'sudo /etc/init.d/harvester-slave start'

scp ./harvester.jar crfharvester@prod7.crf.europeana.eu:/home/crfharvester/harvester/harvester.jar
